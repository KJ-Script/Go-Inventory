  ...
  return (
    <div className="h-screen">
        ...
        <div className="w-full flex justify-center my-[5%] space-x-8">
            ...
            <div className="text-2xl p-4 border shadow-lg flex flex-col items-center">
            <p className="font-bold text text-emerald-700">STORAGE SOLUTIONS</p>
        ...
        <div className="text-center text-2xl border shadow-lg w-[80%] flex justify-center items-center h-full">
